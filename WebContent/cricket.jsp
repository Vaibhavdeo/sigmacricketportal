...
<!--  <link rel="stylesheet" href="D://Storage/J2EE/MyProjects/MailBox/WebContent/bootstrap/css/bootstrap.min.css">  -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
</head>
<body background="images/cricket.jpg">
 <div class="container" color="Red">
   <div class="well well-lg"><h2><font color=blue><marquee direction="left">Welcome to Reister Yourself in Sigma Cricket	</marquee></font></h2></div>
</div>
<div class="container">
